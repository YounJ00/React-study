...
class PhoneInfo extends Component {
    ...
    state = {
        //우리는 수정 버튼을 눌렀을 때 editing 값을 true 로 설정해줄것이다.
        //이 값이 true 일 때는, 기존에 텍스트 형태로 보여주던 값들을
        //input 형태로 보여주게 된다.
        editing: false,
        //input 의 값은 유동적이다.
        //input 값을 담기 위해서 각 필드를 위한 값도 설정한다.
        name: '',
        phone: '',
    }

    handleRemove = () => {
        //삭제 버튼이 클릭되면 onRemove에 id를 넣어서 호출한다.
    ...
    //input에서 onChange 이벤트가 발생될 때 호출되는 함수이다.
    handleChange = (e) => {
    ...
    componentDidUpdate(prevProps, prevState) {
        //여기서는, editing 값이 바뀔 때 처리할 로직을 적는다.
